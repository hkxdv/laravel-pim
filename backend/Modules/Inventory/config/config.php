...
return [
    ...
    'inertia_view_directory' => 'inventory',
    'base_permission' => 'access-inventory',

    // Configuración del ítem de navegación principal
    'nav_item' => [
        'show_in_nav' => true,
        'route_name' => 'internal.inventory.index',
        'icon' => 'ClipboardList',
    ],
    ...
    'breadcrumbs' => [
        'default' => [
            '$ref:breadcrumb_components.inventory_root',
        ],
        'products.index' => [
            '$ref:breadcrumb_components.inventory_root',
